...
/**
 * A data object class directly models database table <tt>cif_user_level</tt>.<br>
 * 用户等级
 * 
 *
...
@ApiModel(value="UserLevelDO对象", description="用户等级")
@TableName("cif_user_level")
public class UserLevelDO implements Serializable  {
    private static final long serialVersionUID = 741231858441822688L;

	public static final String TABLE_NAME = "CIF_USER_LEVEL";
	//===========column onstants=====
	/**
