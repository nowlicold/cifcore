...
/**
 * A data object class directly models database table <tt>cif_one_auth_login_name</tt>.<br>
...
@ApiModel(value="OneAuthLoginNameDO对象", description="单认证登录名列表，1个单认证账号可以有多个登录名")
@TableName("cif_one_auth_login_name")
public class OneAuthLoginNameDO implements Serializable  {
    private static final long serialVersionUID = 741231858441822688L;

	public static final String TABLE_NAME = "CIF_ONE_AUTH_LOGIN_NAME";
	//===========column onstants=====
	/**
