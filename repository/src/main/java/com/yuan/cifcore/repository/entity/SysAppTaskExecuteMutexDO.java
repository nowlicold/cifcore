...
@TableName("sys_app_task_execute_mutex")
@ApiModel(value="SysAppTaskExecuteMutexDO对象", description="应用级任务互斥表")
public class SysAppTaskExecuteMutexDO implements Serializable {
