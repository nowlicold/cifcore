...
/**
 * A data object class directly models database table <tt>one_auth_identity_photo_apply</tt>.<br>
 * 会员单认证身份证照片申请
 * 
 *
...
@ApiModel(value="OneAuthIdentityPhotoApplyDO对象", description="会员单认证身份证照片申请")
@TableName("one_auth_identity_photo_apply")
public class OneAuthIdentityPhotoApplyDO implements Serializable  {
    private static final long serialVersionUID = 741231858441822688L;

	public static final String TABLE_NAME = "ONE_AUTH_IDENTITY_PHOTO_APPLY";
	//===========column onstants=====
	/**
	...
	/**
	 * This constant corresponds to db column <tt>auditor</tt>.<br>
     */
	...
	/**
	 * This property corresponds to db column <tt>auditor</tt>.<br>
     * 审核人
     */
