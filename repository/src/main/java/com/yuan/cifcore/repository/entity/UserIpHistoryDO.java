...
/**
 * A data object class directly models database table <tt>cif_user_ip_history</tt>.<br>
 * 会员历史ip变化记录
 * 
 *
...
@ApiModel(value="UserIpHistoryDO对象", description="会员历史ip变化记录")
@TableName("cif_user_ip_history")
public class UserIpHistoryDO implements Serializable  {
    private static final long serialVersionUID = 741231858441822688L;

	public static final String TABLE_NAME = "CIF_USER_IP_HISTORY";
	//===========column onstants=====
	/**
