...
/**
 * A data object class directly models database table <tt>cif_third_user_mapping_config</tt>.<br>
 * 第三方映射会员配置
 * 
 *
...
@ApiModel(value="ThirdUserMappingConfigDO对象", description="第三方映射会员配置")
@TableName("cif_third_user_mapping_config")
public class ThirdUserMappingConfigDO implements Serializable  {
    private static final long serialVersionUID = 741231858441822688L;

	public static final String TABLE_NAME = "CIF_THIRD_USER_MAPPING_CONFIG";
	//===========column onstants=====
	/**
