...
/**
 * A data object class directly models database table <tt>cif_one_auth_register</tt>.<br>
 * 单认证注册信息
 * 
 *
...
@ApiModel(value="OneAuthRegisterDO对象", description="单认证注册信息")
@TableName("cif_one_auth_register")
public class OneAuthRegisterDO implements Serializable  {
    private static final long serialVersionUID = 741231858441822688L;

	public static final String TABLE_NAME = "CIF_ONE_AUTH_REGISTER";
	//===========column onstants=====
	/**
