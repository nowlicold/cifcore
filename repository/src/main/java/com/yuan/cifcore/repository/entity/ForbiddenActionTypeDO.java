...
/**
 * A data object class directly models database table <tt>cif_forbidden_action_type</tt>.<br>
 * 禁止类型
 * 
 *
...
@ApiModel(value="ForbiddenActionTypeDO对象", description="禁止类型")
@TableName("cif_forbidden_action_type")
public class ForbiddenActionTypeDO implements Serializable  {
    private static final long serialVersionUID = 741231858441822688L;

	public static final String TABLE_NAME = "CIF_FORBIDDEN_ACTION_TYPE";
	//===========column onstants=====
	/**
