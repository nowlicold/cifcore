...
/**
 * A data object class directly models database table <tt>cif_user_account_pwd_verify</tt>.<br>
 * 用户支付密码验证表，一般用于支付密码使用的场景，比如提现、支付等
 * 
 *
...
@ApiModel(value="UserAccountPwdVerifyDO对象", description="用户支付密码验证表，一般用于支付密码使用的场景，比如提现、支付等")
@TableName("cif_user_account_pwd_verify")
public class UserAccountPwdVerifyDO implements Serializable  {
    private static final long serialVersionUID = 741231858441822688L;

	public static final String TABLE_NAME = "CIF_USER_ACCOUNT_PWD_VERIFY";
	//===========column onstants=====
	/**
