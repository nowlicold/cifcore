...
/**
 * A data object class directly models database table <tt>cif_one_auth_validated_cell</tt>.<br>
 * 单登录绑定的手机历史记录
 * 
 *
...
@ApiModel(value="OneAuthValidatedCellDO对象", description="单登录绑定的手机历史记录")
@TableName("cif_one_auth_validated_cell")
public class OneAuthValidatedCellDO implements Serializable  {
    private static final long serialVersionUID = 741231858441822688L;

	public static final String TABLE_NAME = "CIF_ONE_AUTH_VALIDATED_CELL";
	//===========column onstants=====
	/**
