...
@TableName("sch_distribute_task_exec_conf")
@ApiModel(value="SchDistributeTaskExecConfDO对象", description="分布式Task配置")
public class SchDistributeTaskExecConfDO implements Serializable {
    ...
    @ApiModelProperty(value = "运行执行的机器名，多个逗号间隔")
