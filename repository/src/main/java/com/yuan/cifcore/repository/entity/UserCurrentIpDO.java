...
/**
 * A data object class directly models database table <tt>cif_user_current_ip</tt>.<br>
 * 会员当前ip表
 * 
 *
...
@ApiModel(value="UserCurrentIpDO对象", description="会员当前ip表")
@TableName("cif_user_current_ip")
public class UserCurrentIpDO implements Serializable  {
    private static final long serialVersionUID = 741231858441822688L;

	public static final String TABLE_NAME = "CIF_USER_CURRENT_IP";
	//===========column onstants=====
	/**
	...
	/**
	 * This constant corresponds to db column <tt>ip</tt>.<br>
     */
	...
	/**
	 * This property corresponds to db column <tt>ip</tt>.<br>
     * ipv4地址
     */
	private String ip;
