...
/**
 * A data object class directly models database table <tt>cif_one_auth_log</tt>.<br>
 * 单登录日志
 * 
 *
...
@ApiModel(value="OneAuthLogDO对象", description="单登录日志")
@TableName("cif_one_auth_log")
public class OneAuthLogDO implements Serializable  {
    private static final long serialVersionUID = 741231858441822688L;

	public static final String TABLE_NAME = "CIF_ONE_AUTH_LOG";
	//===========column onstants=====
	/**
