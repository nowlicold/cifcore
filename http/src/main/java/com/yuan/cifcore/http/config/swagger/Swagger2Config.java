package com.yuan.cifcore.http.config.swagger;
...
public class Swagger2Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
            .groupName("yuan.cifcore")
            .apiInfo(apiInfo())
            .select()
            // 扫描的包所在位置
            .apis(RequestHandlerSelectors.basePackage("com.yuan.cifcore.http.controller"))
            // 扫描的 URL 规则
