...
@TableName("sys_app_task_execute_config")
@ApiModel(value="SysAppTaskExecuteConfigDO对象", description="应用级Task配置")
public class SysAppTaskExecuteConfigDO implements Serializable {
