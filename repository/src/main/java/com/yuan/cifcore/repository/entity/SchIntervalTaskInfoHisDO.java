...
@TableName("sch_interval_task_info_his")
@ApiModel(value="SchIntervalTaskInfoHisDO对象", description="间隔任务表")
public class SchIntervalTaskInfoHisDO implements Serializable {
    ...
    @ApiModelProperty(value = "历史记录创建时间")
    ...
    public static final String GMT_HIS_CREATE = "gmt_his_create";
